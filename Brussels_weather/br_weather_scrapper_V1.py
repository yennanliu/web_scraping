...
def main_():
    ...
    for k in range(1,10):    
        ...
        url_new = 'https://www.wunderground.com/history/airport/EBFS/2017/11/{}/DailyHistory.html?req_city=&req_state=&req_statename=&reqdb.zip=&reqdb.magic=&reqdb.wmo='.format(k)
        print (url_new)
